...
public class ContaController implements ContaRepository {
	...
	public void sacar(int numero, float valor) {
		...
		if (conta != null) {
			if(conta.sacar(valor) == true)
				System.out.printf(Cores.ANSI_WHITE_BACKGROUND_BRIGHT + Cores.TEXT_PURPLE_BOLD + "O saque no valor %.2f, na conta: %d foi efetuado com sucesso!\n", valor, numero);
		}else {System.out.printf(Cores.TEXT_PURPLE_UNDERLINED + Cores.ANSI_WHITE_BACKGROUND_BRIGHT + "A conta '%d' nao foi encontrada!\n", numero);}	
	}
	...
	public void depositar(int numero, float valor) {
		...
		if (conta != null) {
			conta.depositar(valor);
				System.out.printf(Cores.ANSI_WHITE_BACKGROUND_BRIGHT + Cores.TEXT_PURPLE_BOLD + "O deposito no valor %.2f, na conta: %d foi efetuado com sucesso!\n", valor, numero);
		}else {System.out.printf(Cores.TEXT_PURPLE_UNDERLINED + Cores.ANSI_WHITE_BACKGROUND_BRIGHT + "A conta '%d' nao foi encontrada!\n", numero);}	
	}
		...
		if (contaOrigem != null && contaDestino != null) {
			if(contaOrigem.sacar(valor) == true);{
				...
				System.out.printf(Cores.ANSI_WHITE_BACKGROUND_BRIGHT + Cores.TEXT_PURPLE_BOLD 
						+ "\n A transferência no valor de %.2f da conta %d foi efetuada com sucesso na conta %d!", valor, numeroOrigem, numeroDestino);
			}}else {
			System.out.printf(Cores.TEXT_PURPLE_UNDERLINED + Cores.ANSI_WHITE_BACKGROUND_BRIGHT + "A conta  de Origem e/ou Destino nao foram encontradas!\n");
		}	
	}
	...
	public void listarPorTitular(String titular) {
		...
		if(listaTitulares.isEmpty()) {
			System.out.printf("\nNenhuma conta foi encontrada para titulares com nome: %s", titular);
		}
